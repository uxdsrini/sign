...
function ServicesPage() {
  const services = [
    {
      icon: <Icons.Palette className="w-8 h-8 text-purple-500" />,
    ...
    {
      icon: <Icons.Globe className="w-8 h-8 text-purple-500" />,
      title: "Web Design",
    ...
    {
      icon: <Icons.Users className="w-8 h-8 text-purple-500" />,
      title: "Social Media",
    ...
    {
      icon: <Icons.Package className="w-8 h-8 text-purple-500" />,
    ...
    {
      icon: <Icons.PenTool className="w-8 h-8 text-purple-500" />,
      title: "Print Design",
    ...
    {
      icon: <Icons.BookOpen className="w-8 h-8 text-purple-500" />,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 group">
                ...
                <button className="mt-6 text-purple-600 font-medium inline-flex items-center group-hover:text-purple-700">
